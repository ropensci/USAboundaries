...
create maps of Maryland Congressional elections (to the 115th Congress) and in
...
underlying datasets. For the 2016 Congressional votes, we will use [data
available on the
...
Elections*](https://earlyamericanelections.org/data/) project. We begin by
...
We can load the voting data for the 115th Congress into `md_votes`. We use this
package to get the contemporary (2016) boundaries for Congressional districts in
Maryland. They are returned as an `sf` object from the
...
The data has the percentage of votes for Democrats and Republicans. We are going
